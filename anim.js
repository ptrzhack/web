...
var lyricsData = [
  ...
  { text: "Y es lo que me debilita", time: 38 },
  { text: "Quiero llevarte a una cita", time: 40 },
  { text: "Yo te quiero enseñar todo", time: 43 },
  { text: "El amor que yo te tengo", time: 46 },
  { text: "Tan sencilla que tu eres", time: 49 },
  { text: "Para mi tu eres PERFECTAAA", time: 52 },
  { text: "Yo te quiero amar", time: 53 },
  { text: "Te quiero enseñar", time: 58 },
